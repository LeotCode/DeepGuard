...
class VideoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            ...
            return image_seq, vision_seq, self.labels[idx]
...
if __name__ == "__main__":
    ...
    train_dataset = VideoDataset(train_paths, train_labels, num_frames=args.frames)
    val_dataset = VideoDataset(val_paths, val_labels, num_frames=args.frames)
